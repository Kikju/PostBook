...
class AppApiTest {
    ...
    fun setup() {
        ...
        api = Retrofit.Builder()
            ...
            .client(AppModule.provideHttpClient())
            .build()
    ...
    @Test
    fun testGetPosts_userId1() {
        mockWebServer.enqueue(
            MockResponse()
                .setResponseCode(HttpURLConnection.HTTP_OK)
                .setBody(allPostsForUserId1)
        )
    ...
    @Test
    fun testGetComments_postId1() {
        mockWebServer.enqueue(
            MockResponse()
                .setResponseCode(HttpURLConnection.HTTP_OK)
                .setBody(allCommentsForPostId1)
        )
...
const val allCommentsForPostId1 = """
[
  {
    "postId": 1,
    "id": 1,
